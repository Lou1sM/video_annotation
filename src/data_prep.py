...
example command: 
    p data_prep.py --frame_dir data/frames --input_json data/YT_40_structured_captions.json  --output_jso   n some_file_name.json --output_h5 some_file_name.h5
"""
...
def main(params):
    ...
    if (params.dataset_name == 'msr_vtt'):
        print(videos[np.random.randint(len(videos))].keys())
