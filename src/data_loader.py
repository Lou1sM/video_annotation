...
def load_data_lookup(json_data, video_lookup_table, i3d_lookup_table, batch_size, shuffle):
    new_data = LookupDataset(json_data, video_lookup_table, i3d_lookup_table)
