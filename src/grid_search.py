...
if __name__=="__main__":
    ...
    best_exp_name = grid_search('seq2seq', enc_sizes, dec_sizes, enc_dec_hidden_inits, batch_sizes, lrs, opts, weight_decays, dropouts, enc_layers, dec_layers, teacher_forcing_ratio)
