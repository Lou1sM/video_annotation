...
def get_output(checkpoint_path, input_tensor, target_number_tensor, rnge, mode='eos', device='cuda'):
...
if __name__=="__main__":
	...
	h5_test_generator = load_data_lookup('../data/rdf_video_captions/val_50d.h5', video_lookup_table=test_table, batch_size=num_lines, shuffle=False)
