...
def load_arguments():
    ...
    argparser.add_argument("--enc_init", type=str, choices=['zeroes', 'unit', 'learned', 'unit_learned'], default='zeroes')
    ...
    argparser.add_argument("--model", choices = ['seq2seq', 'reg', 'eos'], default = 'seq2seq', help = "which subnetwork to train")
    ...
    argparser.add_argument("--reload_path", default = None)
    argparser.add_argument("--setting", choices = ["embeddings", "preds", "eos"], default="embeddings", help = "setting to train the NN on")    
...
assert sorted(IMPORTANT_PARAMS) == IMPORTANT_PARAMS
